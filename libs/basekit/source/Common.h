...
/* warning C4244: 'function' : conversion from 'double ' to 'int ', possible
 * loss of data */

#pragma warning(disable : 4996)
/* warning C4996: 'function' : This function or variable may be unsafe. Consider
 * using 'function_s' instead */
