...
#define simd_4i_add(v1, v2, v0)                                                \
    v0.m[0] = _mm_add_pi32(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_add_pi32(v1.m[1], v2.m[1])

/* v0 = 4 ints in v1 subracted from 4 ints in v2 */
#define simd_4i_sub(v1, v2, v0)                                                \
    v0.m[0] = _mm_sub_pi32(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_sub_pi32(v1.m[1], v2.m[1])

/* no integer SIMD mult on IWMMX */
/* v0 = 4 ints in v1 multiplied by 4 ints in v2 */
#define simd_4i_mult(v1, v2, v0)                                               \
...
#define simd_4i_band(v1, v2, v0)                                               \
    v0.m[0] = _mm_and_si64(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_and_si64(v1.m[1], v2.m[1])

/* v0 = 4 ints in v1 | 4 ints in v2 */
#define simd_4i_bor(v1, v2, v0)                                                \
    v0.m[0] = _mm_or_si64(v1.m[0], v2.m[0]);                                   \
    v0.m[1] = _mm_or_si64(v1.m[1], v2.m[1])

/* v0 = 4 ints in v1 ^ 4 ints in v2 */
#define simd_4i_bxor(v1, v2, v0)                                               \
    v0.m[0] = _mm_xor_si64(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_xor_si64(v1.m[1], v2.m[1])

/* V0 = 4 ints in V1, each shifted left  (<<) X bits */
#define simd_4i_shftl(v1, x, v0)                                               \
    v0.m[0] = _mm_sll_pi32(v1.m[0], x);                                        \
    v0.m[1] = _mm_sll_pi32(v1.m[1], x)

/* V0 = 4 ints in V1, each shifted right (>>) X bits */
#define simd_4i_shftr(v1, x, v0)                                               \
    v0.m[0] = _mm_srl_pi32(v1.m[0], x);                                        \
    v0.m[1] = _mm_srl_pi32(v1.m[1], x)

/* Signed shorts (8 packed shorts) */

/* v0 = 8 shorts in v1 added to 8 shorts in v2 */
#define simd_4s_add(v1, v2, v0)                                                \
    v0.m[0] = _mm_add_pi16(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_add_pi16(v1.m[1], v2.m[1])

/* v0 = 8 shorts in v1 subracted from 8 shorts in v2 */
#define simd_4s_sub(v1, v2, v0)                                                \
    v0.m[0] = _mm_sub_pi16(v1.m[0], v2.m[0]);                                  \
    v0.m[1] = _mm_sub_pi16(v1.m[1], v2.m[1])

/* V0 = 8 shorts in V1, each shifted left  (<<) X bits */
#define simd_4s_shftl(v1, x, v0)                                               \
    v0.m[0] = _mm_sll_pi16(v1.m[0], x);                                        \
    v0.m[1] = _mm_sll_pi16(v1.m[1], x)

/* V0 = 8 shorts in V1, each shifted right (>>) X bits */
#define simd_4s_shftr(v1, x, v0)                                               \
    v0.m[0] = _mm_srl_pi16(v1.m[0], x);                                        \
    v0.m[1] = _mm_srl_pi16(v1.m[1], x)

/* Signed chars (16 packed chars) */

/* v0 = 16 chars in v1 added to 16 chars in v2 */
#define simd_4c_add(v1, v2, v0)                                                \
    v0.m[0] = _mm_add_pi8(v1.m[0], v2.m[0]);                                   \
    v0.m[1] = _mm_add_pi8(v1.m[1], v2.m[1])

/* v0 = 16 chars in v1 subracted from 16 chars in v2 */
#define simd_4c_sub(v1, v2, v0)                                                \
    v0.m[0] = _mm_sub_pi8(v1.m[0], v2.m[0]);                                   \
    v0.m[1] = _mm_sub_pi8(v1.m[1], v2.m[1])

/* V0 = 16 chars in V1, each shifted left  (<<) X bits */
#define simd_4c_shftl(v1, x, v0)                                               \
    v0.m[0] = _mm_sll_pi8(v1.m[0], x);                                         \
    v0.m[1] = _mm_sll_pi8(v1.m[1], x)

/* V0 = 16 chars in V1, each shifted right (>>) X bits */
#define simd_4c_shftr(v1, x, v0)                                               \
    v0.m[0] = _mm_srl_pi8(v1.m[0], x);                                         \
    v0.m[1] = _mm_srl_pi8(v1.m[1], x)
...
#define simd_4f_add(v1, v2, v0)                                                \
    v0.f[0] = v1.f[0] + v2.f[0];                                               \
    v0.f[1] = v1.f[1] + v2.f[1];                                               \
    v0.f[2] = v1.f[2] + v2.f[2];                                               \
    v0.f[3] = v1.f[3] + v2.f[3]

/* v0 = 4 floats in v1 subtracted from 4 floats in v2 */
#define simd_4f_sub(v1, v2, v0)                                                \
    v0.f[0] = v1.f[0] - v2.f[0];                                               \
    v0.f[1] = v1.f[1] - v2.f[1];                                               \
    v0.f[2] = v1.f[2] - v2.f[2];                                               \
    v0.f[3] = v1.f[3] - v2.f[3]
...
#define simd_4f_min(v1, v2, v0)                                                \
    v0.f[0] = (v2.f[0] <= v1.f[0] ? v2.f[0] : v1.f[0]);                        \
