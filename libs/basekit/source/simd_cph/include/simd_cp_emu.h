...
#define simd_4s_add(v1, v2, v0)                                                \
    ...
    v0.s[2] = v1.s[2] + v2.s[2];                                               \
    v0.s[3] = v1.s[3] + v2.s[3];                                               \
    v0.s[4] = v1.s[4] + v2.s[4];                                               \
    v0.s[5] = v1.s[5] + v2.s[5];                                               \
    v0.s[6] = v1.s[6] + v2.s[6];                                               \
    v0.s[7] = v1.s[7] + v2.s[7]
...
#define simd_4c_add(v1, v2, v0)                                                \
    ...
    v0.c[4] = v1.c[4] + v2.c[4];                                               \
    v0.c[5] = v1.c[5] + v2.c[5];                                               \
    v0.c[6] = v1.c[6] + v2.c[6];                                               \
    v0.c[7] = v1.c[7] + v2.c[7];                                               \
    v0.c[8] = v1.c[8] + v2.c[8];                                               \
    v0.c[9] = v1.c[9] + v2.c[9];                                               \
    v0.c[10] = v1.c[10] + v2.c[10];                                            \
    v0.c[11] = v1.c[11] + v2.c[11];                                            \
    v0.c[12] = v1.c[12] + v2.c[12];                                            \
    v0.c[13] = v1.c[13] + v2.c[13];                                            \
    v0.c[14] = v1.c[14] + v2.c[14];                                            \
    v0.c[15] = v1.c[15] + v2.c[15]
