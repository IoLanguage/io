...
BASEKIT_API void UArray_unsupported_with_(const UArray *self,
                                          const char *methodName,
                                          const UArray *other);
BASEKIT_API void UArray_error_(const UArray *self, char *e);

BASEKIT_API UArray *UArray_new(void);
BASEKIT_API UArray *UArray_newWithData_type_size_copy_(void *data, CTYPE type,
                                                       size_t size, int copy);
BASEKIT_API UArray *UArray_newWithData_type_encoding_size_copy_(
    void *bytes, CTYPE type, CENCODING encoding, size_t size, int copy);
...
BASEKIT_API void UArray_setData_type_size_copy_(UArray *self, void *data,
                                                CTYPE type, size_t size,
                                                int copy);
...
BASEKIT_API UArray UArray_stackAllocedWithData_type_size_(void *data,
                                                          CTYPE type,
                                                          size_t size);
...
#define UArray_minSizeWith_(self, other)                                       \
    self->size < other->size ? self->size : other->size
#define UArray_minSizeInBytesWith_(self, other)                                \
    self->size * self->itemSize < other->size * other->itemSize                \
...
BASEKIT_API void UArray_at_putAll_(UArray *self, size_t pos,
                                   const UArray *other);
...
BASEKIT_API void UArray_appendBytes_size_(UArray *self, const uint8_t *bytes,
                                          size_t size);
// BASEKIT_API void UArray_appendByte_(UArray *self, uint8_t byte);

BASEKIT_API void UArray_insert_every_(UArray *self, UArray *other,
                                      size_t itemCount);

// remove

BASEKIT_API void UArray_removeRange(UArray *self, size_t start, size_t size);
BASEKIT_API void UArray_leave_thenRemove_(UArray *self, size_t itemsToLeave,
...
#define UARRAY_RAWAT_(self, i)                                                 \
    ...
    case CTYPE_uint16_t:                                                       \
        return ((uint16_t *)self->data)[i];                                    \
    case CTYPE_uint32_t:                                                       \
        return ((uint32_t *)self->data)[i];                                    \
    case CTYPE_uint64_t:                                                       \
        return ((uint64_t *)self->data)[i];                                    \
    case CTYPE_int8_t:                                                         \
        return ((int8_t *)self->data)[i];                                      \
    case CTYPE_int16_t:                                                        \
        return ((int16_t *)self->data)[i];                                     \
    case CTYPE_int32_t:                                                        \
        return ((int32_t *)self->data)[i];                                     \
    case CTYPE_int64_t:                                                        \
        return ((int64_t *)self->data)[i];                                     \
    case CTYPE_float32_t:                                                      \
        return ((float32_t *)self->data)[i];                                   \
    case CTYPE_float64_t:                                                      \
        return ((float64_t *)self->data)[i];                                   \
    case CTYPE_uintptr_t:                                                      \
        return ((uintptr_t *)self->data)[i];                                   \
    }
...
#define DUARRAY_INTOTHER(MACRO, OP, TYPE1, self, other)                        \
    ...
    case CTYPE_uint8_t:                                                        \
        MACRO(OP, TYPE1, self, uint8_t, other);                                \
        break;                                                                 \
    case CTYPE_uint16_t:                                                       \
        MACRO(OP, TYPE1, self, uint16_t, other);                               \
        break;                                                                 \
    case CTYPE_uint32_t:                                                       \
        MACRO(OP, TYPE1, self, uint32_t, other);                               \
        break;                                                                 \
    case CTYPE_int8_t:                                                         \
        MACRO(OP, TYPE1, self, int8_t, other);                                 \
        break;                                                                 \
    case CTYPE_int16_t:                                                        \
        MACRO(OP, TYPE1, self, int16_t, other);                                \
        break;                                                                 \
    case CTYPE_int32_t:                                                        \
        MACRO(OP, TYPE1, self, int32_t, other);                                \
        break;                                                                 \
    case CTYPE_uintptr_t:                                                      \
        MACRO(OP, TYPE1, self, uintptr_t, other);                              \
        break;                                                                 \
    default:                                                                   \
        UArray_error_(self, "unsupported array op");                           \
    }
...
#define DUARRAY_OTHER(MACRO, OP, TYPE1, self, other)                           \
    ...
    case CTYPE_uint32_t:                                                       \
        ...
        break;                                                                 \
    case CTYPE_uint64_t:                                                       \
        MACRO(OP, TYPE1, self, uint64_t, other);                               \
        break;                                                                 \
    case CTYPE_int8_t:                                                         \
        MACRO(OP, TYPE1, self, int8_t, other);                                 \
        break;                                                                 \
    ...
    case CTYPE_int32_t:                                                        \
        ...
        break;                                                                 \
    case CTYPE_int64_t:                                                        \
        MACRO(OP, TYPE1, self, int64_t, other);                                \
        break;                                                                 \
    case CTYPE_float32_t:                                                      \
        MACRO(OP, TYPE1, self, float32_t, other);                              \
        break;                                                                 \
    case CTYPE_float64_t:                                                      \
        MACRO(OP, TYPE1, self, float64_t, other);                              \
        break;                                                                 \
    case CTYPE_uintptr_t:                                                      \
        MACRO(OP, TYPE1, self, uintptr_t, other);                              \
        break;                                                                 \
...
#define DUARRAY_INTSELF(MACRO, OP, self, other)                                \
    switch (self->itemType) {                                                  \
    case CTYPE_uint8_t:                                                        \
        DUARRAY_INTOTHER(MACRO, OP, uint8_t, self, other);                     \
    case CTYPE_uint16_t:                                                       \
        DUARRAY_INTOTHER(MACRO, OP, uint16_t, self, other);                    \
    case CTYPE_uint32_t:                                                       \
        DUARRAY_INTOTHER(MACRO, OP, uint32_t, self, other);                    \
    case CTYPE_int8_t:                                                         \
        DUARRAY_INTOTHER(MACRO, OP, int8_t, self, other);                      \
    case CTYPE_int16_t:                                                        \
        DUARRAY_INTOTHER(MACRO, OP, int16_t, self, other);                     \
    case CTYPE_int32_t:                                                        \
        DUARRAY_INTOTHER(MACRO, OP, uint32_t, self, other);                    \
    default:                                                                   \
        UArray_error_(self, "unsupported array op");                           \
...
#define DUARRAY_SELF(MACRO, OP, self, other)                                   \
    switch (self->itemType) {                                                  \
    case CTYPE_uint8_t:                                                        \
        DUARRAY_OTHER(MACRO, OP, uint8_t, self, other);                        \
    case CTYPE_uint16_t:                                                       \
        DUARRAY_OTHER(MACRO, OP, uint16_t, self, other);                       \
    case CTYPE_uint32_t:                                                       \
        DUARRAY_OTHER(MACRO, OP, uint32_t, self, other);                       \
    case CTYPE_uint64_t:                                                       \
        DUARRAY_OTHER(MACRO, OP, uint64_t, self, other);                       \
    case CTYPE_int8_t:                                                         \
        DUARRAY_OTHER(MACRO, OP, int8_t, self, other);                         \
    case CTYPE_int16_t:                                                        \
        DUARRAY_OTHER(MACRO, OP, int16_t, self, other);                        \
    case CTYPE_int32_t:                                                        \
        DUARRAY_OTHER(MACRO, OP, uint32_t, self, other);                       \
    case CTYPE_int64_t:                                                        \
        DUARRAY_OTHER(MACRO, OP, uint64_t, self, other);                       \
    case CTYPE_float32_t:                                                      \
        DUARRAY_OTHER(MACRO, OP, float32_t, self, other);                      \
    case CTYPE_float64_t:                                                      \
        DUARRAY_OTHER(MACRO, OP, float64_t, self, other);                      \
    case CTYPE_uintptr_t:                                                      \
        DUARRAY_OTHER(MACRO, OP, uintptr_t, self, other);                      \
    }
...
#define UARRAY_FUNCTION_TYPES(FUNCTION_NAME, TYPE1, self, TYPE2, other)        \
    {                                                                          \
        size_t i,                                                              \
            minSize = self->size < other->size ? self->size : other->size;     \
        for (i = 0; i < minSize; i++) {                                        \
            ((TYPE1 *)self->data)[i] = FUNCTION_NAME(                          \
                ((TYPE1 *)self->data)[i], (TYPE1)((TYPE2 *)other->data)[i]);   \
        }                                                                      \
        return;                                                                \
    }

// printf("%i: " #TYPE1 " %f " #OP2 " " #TYPE2 " %i\n", i, ((TYPE1
// *)self->data)[i], ((TYPE2 *)other->data)[i]);
...
#define UARRAY_FOREACH_CASETYPE_(self, i, v, code, TYPE)                       \
    case CTYPE_##TYPE:                                                         \
        UARRAY_FOREACHTYPE(self, i, v, code, TYPE);                            \
        break;
...
#define UARRAY_RFOREACH_CASETYPE_(self, i, v, code, TYPE)                      \
    case CTYPE_##TYPE:                                                         \
        UARRAY_RFOREACHTYPE(self, i, v, code, TYPE);                           \
        break;
...
#define UARRAY_FOREACHASSIGN(self, i, v, code)                                 \
    switch (self->itemType) {                                                  \
    case CTYPE_uint8_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, uint8_t);                   \
        break;                                                                 \
    case CTYPE_uint16_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, uint16_t);                  \
        break;                                                                 \
    case CTYPE_uint32_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, uint32_t);                  \
        break;                                                                 \
    case CTYPE_uint64_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, uint64_t);                  \
        break;                                                                 \
    case CTYPE_int8_t:                                                         \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, int8_t);                    \
        break;                                                                 \
    case CTYPE_int16_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, int16_t);                   \
        break;                                                                 \
    case CTYPE_int32_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, int32_t);                   \
        break;                                                                 \
    case CTYPE_int64_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, int64_t);                   \
        break;                                                                 \
    case CTYPE_float32_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, float32_t);                 \
        break;                                                                 \
    case CTYPE_float64_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, float64_t);                 \
        break;                                                                 \
    case CTYPE_uintptr_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN(self, i, v, code, uintptr_t);                 \
        break;                                                                 \
    }
...
#define UARRAY_FOREACHASSIGN_VALUE_UNUSED(self, i, code)                       \
    switch (self->itemType) {                                                  \
    case CTYPE_uint8_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, uint8_t);         \
        break;                                                                 \
    case CTYPE_uint16_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, uint16_t);        \
        break;                                                                 \
    case CTYPE_uint32_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, uint32_t);        \
        break;                                                                 \
    case CTYPE_uint64_t:                                                       \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, uint64_t);        \
        break;                                                                 \
    case CTYPE_int8_t:                                                         \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, int8_t);          \
        break;                                                                 \
    case CTYPE_int16_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, int16_t);         \
        break;                                                                 \
    case CTYPE_int32_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, int32_t);         \
        break;                                                                 \
    case CTYPE_int64_t:                                                        \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, int64_t);         \
        break;                                                                 \
    case CTYPE_float32_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, float32_t);       \
        break;                                                                 \
    case CTYPE_float64_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, float64_t);       \
        break;                                                                 \
    case CTYPE_uintptr_t:                                                      \
        UARRAY_FOREACHTYPEASSIGN_VALUE_UNUSED(self, i, code, uintptr_t);       \
        break;                                                                 \
    }
