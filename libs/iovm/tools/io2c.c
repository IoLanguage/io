...
void showUsage(void)
{
	...
	printf("output is sent to standard output\n");
        printf("ParseFunctionName is either IoState_on_doCString_withLabel_ or IoState_on_doPackedCString_withLabel_\n\n");
}
...
void processFile(const char *objectName, const char *fileName, const char *parseFunctionName)
{	
