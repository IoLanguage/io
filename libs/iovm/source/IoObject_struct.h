...
#define IoObject_deref(self) ((IoObjectData *)(((CollectorMarker *)(self))->object))
...
#define IoObject_setDataUint32_(self, v)    IoObject_deref(self)->data.ui32 = (uint32_t)(v);

#define IoObject_isActivatable_(self, b)    IoObject_deref(self)->isActivatable = b;
...
#define IoObject_hasDoneLookup_(self, v) IoObject_deref(self)->hasDoneLookup = v;
