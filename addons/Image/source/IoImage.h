...
IOIMAGE_API IoObject *IoImage_resizeTo(IoImage *self, IoObject *locals, IoMessage *m);
IOIMAGE_API IoObject *IoImage_resizeToPowerOf2(IoImage *self, IoObject *locals, IoMessage *m);
