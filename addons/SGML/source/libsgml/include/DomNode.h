 ...
 */
SGML_API DOM_NODE *domNodeNew(unsigned long type, const char *name, const char *value);
/**
 * Destroys a specific node.  This is only used internally.
 *
 * @param  node [in] The node to deinitialize.
 */
SGML_API void domNodeDestroySpecific(DOM_NODE *node);
/**
 * Recursively destroys a given node.
 *
 * @param  node [in] The node to destroy.
 */
SGML_API void domNodeDestroy(DOM_NODE *node);
 ...
 */
SGML_API void domNodeAppendChild(DOM_NODE *parent, DOM_NODE *child);
/**
 ...
 */
SGML_API void domNodeAppendSibling(DOM_NODE *node, DOM_NODE *sibling);
/**
 * Removes a child.
 *
 ...
 */
SGML_API void domNodeRemoveChild(DOM_NODE *parent, DOM_NODE *child);
 ...
 */
SGML_API DOM_NODE *domNodeGetFirstChild(DOM_NODE *node);
/**
 ...
 */
SGML_API DOM_NODE *domNodeGetPreviousSibling(DOM_NODE *node);
/**
 ...
 */
SGML_API DOM_NODE *domNodeGetNextSibling(DOM_NODE *node);
 ...
 */
SGML_API void domNodeSetName(DOM_NODE *node, const char *name);
/**
 ...
 */
SGML_API const char *domNodeGetName(DOM_NODE *node);
 ...
 */
SGML_API void domNodeSetValue(DOM_NODE *node, const char *value);
 ...
 */
SGML_API void domNodeSetValueVariant(DOM_NODE *node, enum VariantType type, void *value, unsigned long valueSize);
/**
 ...
 */
SGML_API const char *domNodeGetValue(DOM_NODE *node);
/**
 ...
 */
SGML_API void *domNodeGetValueVariant(DOM_NODE *node, enum VariantType type);
 ...
 */
SGML_API DOM_NODE *domNodeFindNodeByName(DOM_NODE *node, const char *name);
/**
 ...
 */
SGML_API struct _dom_node_list *domNodeFindNodesByName(DOM_NODE *node, const char *name);
SGML_API void domNodeFindNodesByName_r(struct _dom_node_list *nodeList, DOM_NODE *node, const char *name);
 ...
 */
SGML_API void domNodeSerializeToFile(DOM_NODE *node, const char *fileName);
/**
 ...
 */
SGML_API void domNodeSerializeToFd(DOM_NODE *node, FILE *fd);
/**
 ...
 */
SGML_API unsigned long domNodeSerializeToString(DOM_NODE *node, char **string);

SGML_API void domNodeSerializeToString_r(DOM_NODE *node, char **string, unsigned long *stringLength);
