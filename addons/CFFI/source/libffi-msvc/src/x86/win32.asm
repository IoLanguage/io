...
ffi_closure_raw_SYSV PROC NEAR USES esi
    ;; the ffi_closure ctx is passed in eax by the trampoline.
        ...
        sub  esp, 40
        mov  esi, [eax + ((13 + 3) AND NOT 3)]        ;; closure->cif
        mov  edx, [eax + ((((13 + 3) AND NOT 3) + 4) + 4)]  ;; closure->user_data
        ...
        mov  [esp + 4], edx                             ;; &res
        mov  [esp], esi                                 ;; cif
        call DWORD PTR [eax + (((13 + 3) AND NOT 3) + 4)]   ;; closure->fun
...
cr_jumpdata:
        ...
        dd offset cr_retint8        ;; 5
        dd offset cr_retint8        ;; 6
        dd offset cr_retint16       ;; 7
        dd offset cr_retint16       ;; 8
        ...
        dd offset cr_retint8        ;; (14 + 1)
        dd offset cr_retint16       ;; (14 + 2)
